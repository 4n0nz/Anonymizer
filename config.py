...
MAX_WIDTH        = 960   # réduit de 1280 → gain CPU immédiat (face detection)

# Pré-traitement automatique des sources trop grandes (avant pipeline)
# 0 = désactivé | 1280 = downscale à 720p | 1920 = downscale à 1080p
PREPROCESS_MAX_WIDTH = 1920

# ======================
# FACE MASK
# ======================
MAX_FACES      = 1
DETECT_SCALE   = 1.0   # 2.0 = upscale x2 avant détection → trop lent sur Windows
EMA_ALPHA      = 0.35   # Lissage temporel (0 = immobile, 1 = pas de lissage)
FEATHER_RADIUS = 6      # Réduit de 11 → moins de blur = plus rapide
...
PIP_ZOOM_FACTOR     = 0.9    # Agrandissement du PIP final (1.0 = taille safe zone exacte, 0.9 = -10%)
