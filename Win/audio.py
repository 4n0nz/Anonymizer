...
def require_ffmpeg():
    if not shutil.which("ffmpeg"):
        raise RuntimeError("ffmpeg introuvable. Installez-le et ajoutez-le au PATH.")
    if not shutil.which("ffprobe"):
        raise RuntimeError("ffprobe introuvable. Installez-le et ajoutez-le au PATH.")
...
def main():
    ...
    if not videos:
        raise RuntimeError("Aucune video trouvee dans input")
